...
|customRewardId | string | This is either the customRewardId for channelpoint redemptions or `null` | `"1234abcd-26ec-420d-af12-ff8790cb5094"`                                                                                                                                                                                                                                                                         |
...
|time           | Date   | A Date object refering to the time the message was sent                  | A [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) instance                                                                                                                                                                                                         |
...
# Custom Rewards
Custom rewards are channelpoint redemptions and individually configurable by broadcasters.
